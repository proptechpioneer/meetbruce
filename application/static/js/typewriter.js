...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (messageElement && chatContainer) {
        ...
        setTimeout(() => {
            ...
            const lines = [
                "Did you know that most landlords have advanced software platforms to manage their property and tenants",
                "There are hundreds of options for them to choose from",
                "These platforms help them efficiently manage every element of their property",
                "The software ensures they collect rent on time, get as much rent as possible and vets their tenants",
                ...
                "The Renters' Rights Act will be the biggest shake up of the English rental market in 40 years",
